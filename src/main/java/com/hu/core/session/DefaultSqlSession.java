...
import com.hu.core.agency.MapperAgency;
...
public class DefaultSqlSession implements SqlSession{
    ...
    public <T> List<T> selectList(String statemenId, Object... param) throws Exception {
        return (List<T>) doExecutor("List",statemenId,  param);
    }
    ...
    public int update(String statemenId, Object... param) throws Exception {
        return (int) doExecutor("Integer",statemenId,  param);
    }
    ...
    @Override
    public Object doExecutor(String typeName,String statemenId, Object... param) throws Exception {
